...
TOUR_CODE_RE = re.compile(r'\b((?:ZT1|ZT|LN|KT|DT1|DT2|LT)-?\d{4})\b')

def _norm_code(code: str) -> str:
    return re.sub(r'(ZT1|ZT|LN|KT|DT1|DT2|LT)(\d{4})', r'\1-\2', code)
...
_VENDOR_MAP = {
    ...
    'ლილატი':                   'Lilati Mestia',
    'მესტია ლილატი':            'Lilati Mestia',
    'lilat':                    'Lilati Mestia',
