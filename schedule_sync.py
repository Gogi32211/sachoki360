...
TOUR_CODE_RE = re.compile(r'\b((?:ZT1|ZT|LN|KT|DT1|DT2|LT|HM1|HM2|HM|HT1|HT2|HT3|HT|TH|TK|TM|TV|MT|ST)-?\d{4})\b')
...
def _norm_code(code: str) -> str:
    return re.sub(r'(ZT1|ZT|LN|KT|DT1|DT2|LT|HM1|HM2|HM|HT1|HT2|HT3|HT|TH|TK|TM|TV|MT|ST)(\d{4})', r'\1-\2', code)
